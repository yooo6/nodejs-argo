...
const FILE_PATH = process.env.FILE_PATH || '.yyy';   // 运行目录,sub节点文件保存目录
const SUB_PATH = process.env.SUB_PATH || '30242';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '9afd1229-b893-40c1-84dd-51e7ce204999'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
